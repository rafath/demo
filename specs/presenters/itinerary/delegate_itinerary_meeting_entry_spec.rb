...
describe Itinerary::DelegateItineraryMeetingEntry do
  ...
  let!(:entry) { Itinerary::DelegateItineraryMeetingEntry.new(slot, delegate) }
  ...
  it 'has records' do
    ...
    expect(entry.records).to include(Itinerary::DelegateAppointmentGap)
  end
end